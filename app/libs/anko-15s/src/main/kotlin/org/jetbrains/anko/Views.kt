...
public inline fun ViewManager.space(inlineOptions(InlineOption.ONLY_LOCAL_RETURN) init: android.support.v4.widget.Space.() -> Unit): android.support.v4.widget.Space = addView<android.support.v4.widget.Space> {
    ctx ->
